...
#### Manual Verification:
- [x] Enter scenario query (e.g., "What if I retire at 65?")
- [x] Confirm parsed fields in dialog
- [x] Scenario explanation appears with "Compared to your base plan..."
- [x] Key changes show with colored indicators
- [x] "Reset to Base" button returns to original projection
- [x] New scenario after reset works correctly
- [x] Loading state shows "Analyzing scenario impact..."
